...
// CLampDoc serialization

void CLampDoc::Serialize(CArchive& ar)
{
	if (ar.IsStoring())
	{
...
void CLampDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CLampDoc::InitializeSearchContent()
{
...
void CLampDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
